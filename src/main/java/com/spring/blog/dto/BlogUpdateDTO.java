...
/*
엔터티 클래스는 DB테이블에 대응하는 자바클래스 이고, 데이터 전달을 위한 목적보다는
정의를 위해서 쓰는 경우가 더 많다. 따라서 실질적으로 역직렬화나 직렬화를 위한 로직에는 DTO라는 클래스를 만들고
...
public class BlogUpdateDTO {
    ...
    // 엔터티는 DTO의 구조와 상관없이 작동해야 하므로, 엔터티를 DTO로 바꾸는건 가능해야 하지만 그 반대는 성립 불가
